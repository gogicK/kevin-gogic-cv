        ...
        <section className="snap-start min-h-[calc(100vh-76px)] w-full grid grid-cols-3 bg-white">
            <div className="col-span-3 lg:col-span-2 p-4 mt-4 lg:mt-0 lg:p-20 flex flex-col justify-center gap-4">
                ...
                <p className="italic indent-12 text-justify text-base lg:text-lg">
                    ...
                    <b>Attentif</b> <span className="text-secondaryDark">à la qualité du code, à la maintenabilité des solutions</span> et à la <span className="text-secondaryDark">satisfaction des utilisateurs</span> finaux.
                </p>
            </div>
            ...
            <div className="order:4 lg:order-5 col-span-3 lg:col-span-2 p-4 lg:p-20 flex flex-col justify-center gap-4">
                <h2>Designer</h2>
                <p className="italic indent-12 text-justify text-base lg:text-lg">
                    <span className="text-secondaryDark">Designer en herbe</span>, passionné par la <b>création</b> et animé par une <span className="text-secondaryDark">forte volonté d'apprendre.</span><br />
                    Chaque nouveau projet est pour moi l'occasion d'<b>explorer</b> <span className="text-secondaryDark">de nouvelles idées, d'acquérir de nouvelles compétences et de donner vie à des concepts uniques.</span>
                </p>
            </div>
        </section>
    );
