...
export default function Description() {
    return (
        <section className="snap-start min-h-[calc(100vh-76px)] w-full grid grid-cols-3 bg-white">
            ...
            <div className="col-span-1 flex justify-center items-center"><img className="max-w-96 max-h-96 border-black border-2 rounded-full md:max-w-[70%] sm:max-w-[50%]" alt="capybara developpeur" src={process.env.PUBLIC_URL + '/images/capybara-developpeur.png'} /></div>
            <hr className="col-span-3 border-secondaryDark border-2 mx-20" />
            <div className="col-span-1 flex justify-center items-center"><img className="max-w-96 max-h-96 border-black border-2 rounded-full md:max-w-[70%] sm:max-w-[50%]" alt="capybara peintre" src={process.env.PUBLIC_URL + '/images/capybara-peintre.png'} /></div>
            <div className="col-span-2 p-20 flex flex-col justify-center gap-4">
                <h2>Designer</h2>
                <p className="italic indent-12 text-justify">
