export default function About() {
    return (
        <>
            <section className='font-poppins flex flex-col justify-center items-center px-20 md:px-40 h-[calc(100vh-76px)] space-y-4 leading-relaxed bg-pattern'>
                <div className="bg-white p-8 bg-opacity-75 shadow-xl rounded-xl">
                    <div>
                        <h1 className="text-2xl p-4 text-indigo-500 text-justify">A propos de ce site</h1>
